...
<header>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        if(!empty($admin) && $admin == 1){
            ...
            <a class="nav-link" href="https://mmi.romainpltr.fr/dutaf/admin/bd/bd_gestion.php" tabindex="-1" aria-disabled="true">Gestion de la base de données</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="https://mmi.romainpltr.fr/dutaf/admin/auteurs/auteur_gestion.php" tabindex="-1" aria-disabled="true">Gestion des auteurs</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="https://mmi.romainpltr.fr/dutaf/admin/editeurs/editeur_gestion.php" tabindex="-1" aria-disabled="true">Gestion des éditeurs</a>
        </li>';
        }
